...
![Sencha Grouped Contacts list](docs/Sencha_device_api_contact_list.png)

![Device Contacts GUI](docs/Sencha_device_api_contact_gui.png)
...
![Log Message screen](docs/Sencha_device_api_log.png)
...
![Data Storage screen](docs/Sencha_device_api_data.png)
...
![Geolocation values](docs/Sencha_device_api_geolocation.png)
...
![Accelerometer values](docs/Sencha_device_api_acclerometer.png)
...
![Notification screen](docs/Sencha_device_api_notify.png)
...
![Photos screen](docs/Sencha_device_api_photo.png)
...
![SMS and E-mail options](docs/Sencha_device_api_messaging.png)
...
![Orientation value](docs/Sencha_device_api_orientation.png)
...
![Map loaded and initialised](docs/Sencha_device_api_map.png)
...
![Options before playing](docs/Sencha_device_api_audio_opts.png)

![Audio successfully playing](docs/Sencha_device_api_audio_playing.png)

![Options while playing](docs/Sencha_device_api_audio_opts_while_playing.png)
...
![Webview in action](docs/Sencha_device_api_webview.png)
